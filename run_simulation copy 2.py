...
from influencelimiters.influencelimiter9 import InfluenceLimiter9
...
il_ucb_9 = InfluenceLimiter9(copy.deepcopy(bayes_ucb), nature.agency, num_reports, np.exp(-1))
il_ucb_2 = InfluenceLimiter2(copy.deepcopy(bayes_ucb), nature.agency, num_reports, np.exp(-1))
il_ucb_21 = InfluenceLimiter21(copy.deepcopy(bayes_ucb), nature.agency, num_reports, np.exp(-1))
...
bandits = [il_ucb_2, il_ucb_6, il_ucb_7, il_ucb_8, il_ucb_9, il_ucb_21]


key_map = {il_ucb_21:"il_ucb_21", il_ucb_2: "il_ucb_2", il_ucb_6: "il_ucb_6", il_ucb_7: "il_ucb_7", il_ucb_8: "il_ucb_8", il_ucb_9: "il_ucb_9"}
key_color = {il_ucb_21:"purple", il_ucb_2: "blue", il_ucb_6:"orange", il_ucb_7: "red", il_ucb_8: "green", il_ucb_9:"black"}
