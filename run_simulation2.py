...
oracle = Oracle3(copy.deepcopy(bayes_ucb), nature.agency)
...
bandits = [proposed_il_ucb, old_il_ucb, nil_b, nil_c]
# bandits = [il_ucb]

key_map = {bayes_ucb: "bayes_ucb", il_rep_0: "il_rep_0", proposed_il_ucb: "proposed_il_ucb", old_il_ucb: "old_il_ucb", il_rep_5: "il_rep_5", oracle_test:"oracle_test", nil_b:"nil_b", nil_c:"nil_c", il_random:"il_random"}
key_color = {il_rep_0: "red", proposed_il_ucb: "green", old_il_ucb: "blue", il_rep_5: "yellow", bayes_ucb:"purple", oracle_test:"purple", nil_b:"orange", nil_c:"black", il_random:"orange"}
