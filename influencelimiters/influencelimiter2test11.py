    ...
    def _compute_IL_posterior(self):
        ...
        for (arm_index, arm) in enumerate(self.bandit.arms):
            ...
            for agent_index, agent in enumerate(self.agency.agents):
                ...
                if gamma >= 1:
                    alpha_j = copy.deepcopy(alpha_tilde)
                    beta_j = copy.deepcopy(beta_tilde)
            ...
            # print("Post params:", alpha_test + alpha_tilde, beta_test + beta_tilde)
