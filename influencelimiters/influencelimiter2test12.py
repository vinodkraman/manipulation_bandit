...
class InfluenceLimiter2test12():
    ...
    def _compute_T_posterior(self, selected_arm, reward):
        ...
        for agent_index, agent in enumerate(self.agency.agents):
            ...
            if gamma >= 1:
                # print(agent_index)
                alpha_test += self.agency.agent_reports[agent_index][selected_arm]*agent.num_reports
                beta_test += (1-self.agency.agent_reports[agent_index][selected_arm])*agent.num_reports
