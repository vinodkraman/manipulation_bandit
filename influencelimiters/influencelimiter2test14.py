    ...
    def _compute_IL_posterior(self):
        ...
        for (arm_index, arm) in enumerate(self.bandit.arms):
            ...
            for agent_index, agent in enumerate(self.agency.agents):
                ...
                alpha_j = alpha_test + self.agency.agent_reports[agent_index][arm_index]*agent.num_reports
                beta_j = beta_test + (1-self.agency.agent_reports[agent_index][arm_index])*agent.num_reports
